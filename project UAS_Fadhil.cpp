...
void tambahLagu(vector<Lagu>& playlist, const string& judul, const string& artis) {
    ...
    cout << "Lagu ditambahkan ke Fadhil Amar Zuhair's Playlist" << endl;
}

// Fungsi untuk menampilkan playlist
void tampilkanPlaylist(const vector<Lagu>& playlist) {
    cout << "Playlist Fadhil Amar Zuhair's Playlist dan Favorite Playlist:" << endl << endl;
...
int main() {
    ...
    do {
        // Menampilkan menu
        cout << "Menu:" << endl << endl;
        cout << "1. Tambah Lagu ke Fadhil Amar Zuhair's Playlist" << endl;
